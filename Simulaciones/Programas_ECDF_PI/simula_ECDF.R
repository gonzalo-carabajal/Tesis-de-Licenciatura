...
simulacion_ECDF_ROC_Dirichlet<- function(Nrep=1000, grilla_p, ejex,ejey, nD, nH, 
	...
	ARCHIVO_AUC_EST <- 'AUC_est_modelo1.txt'

	ARCHIVO_MSE_ROC <- 'MSE_ROC_x_modelo1.txt'
 	ARCHIVO_MAXDIF_ROC <- 'MAXDIF_ROC_x_modelo1.txt'


 	ARCHIVO_AUC_EST_PI <- 'AUC_PI_est_modelo1.txt'

	ARCHIVO_MSE_ROC_PI <- 'MSE_PI_ROC_x_modelo1.txt'
 	ARCHIVO_MAXDIF_ROC_PI <- 'MAXDIF_PI_ROC_x_modelo1.txt'
	...
	#archivo <- paste('simu-ROC',para_pegar,'.RData', sep='')
	#save.image(archivo)
