...
carpeta=paste('ROC_modelo1_SM_nD_', nD, '_n_H_', nH,  
	dist_eps$type_H,'_', dist_eps$type_D, '_',
	dist_eps$gl_H,'_', dist_eps$gl_D,sep='')

archivo =paste('simu-ROC_modelo1_SM_',
		dist_eps$type_H,'_', dist_eps$type_D, '_',
...
simulacion_SMOOTH_ROC_Dirichlet(Nrep=Nrep, grilla_p=grilla_p, ejex=ejex,ejey=ejey, 
				nD=nD, nH=nH, 
