...
simulacion_SMOOTH_ROC_UNIF<- function(Nrep=1000, grilla_p, ejex,ejey, nD, nH, 
					...
					a1H=c(-2,2),a2H=c(-2,2), 
				       ...
				       carpeta='ROC_UNIF',
					archivo ='simu-ROC_UNIF.RData', ache=NULL, nucleo="epan") {
	...
	ARCHIVO_AUC_EST_SMOOTH <- 'AUC_SMOOTH_est_modelo1_unif.txt'

	ARCHIVO_MSE_ROC_SMOOTH <- 'MSE_SMOOTH_ROC_x_modelo1_unif.txt'
 	ARCHIVO_MAXDIF_ROC_SMOOTH <- 'MAXDIF_SMOOTH_ROC_x_modelo1_unif.txt'
