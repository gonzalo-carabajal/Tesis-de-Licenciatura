...
carpeta=paste('ROC_modelo1_nD_', nD, '_n_H_', nH, '_Nrep_',Nrep,'_',
	dist_eps$type_H,'_', dist_eps$type_D, '_',
	dist_eps$gl_H,'_', dist_eps$gl_D,sep='')

archivo =paste('simu-ROC_modelo1_',
		dist_eps$type_H,'_', dist_eps$type_D, '_',
...
simulacion_BOTH_ROC_Dirichlet(Nrep=Nrep, grilla_p=grilla_p, ejex=ejex,ejey=ejey, 
				nD=nD, nH=nH, 
...
dist_eps =list(type_H ='uniform', type_D='uniform', gl_H=NA, gl_D=NA)
